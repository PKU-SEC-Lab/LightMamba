...
class RMSNORM_QUANT_1_Blackbox extends BlackBox {
  val top_name: String = "RMSNORM_QUANT_1"
...
class RMSNORM_QUANT_1 extends Component {
  val top_name: String = "RMSNORM_QUANT_1"
  setDefinitionName(top_name + "_wrapper")
  private val black_box = new RMSNORM_QUANT_1_Blackbox
  val io = new Bundle {
...
object simulate_rmsnorm_quant_1 extends App {
  redirect_std("RMSNORM_QUANT_1.log")
  ...
  spinalConfig.generateVerilog(new RMSNORM_QUANT_1)
  ...
  SimConfig
    ...
    .doSimUntilVoid { dut =>
      ...
      // arrays
      val x = read_multi_int64_files(format_str, L, "/before_rms1_layer", T * C)
      val xln_q = read_multi_int64_files(format_str, L, "/rms1_q_layer", T * C)
      val xln_s  = read_multi_int64_files(format_str, L, "/rms1_s_layer", T * CT)
