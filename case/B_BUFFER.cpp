...
/**
 * @brief Top-level function that buffers MHA input data.
 *
 * @param i_stream     Input stream for q values (quantized input)
 * @param i_s_stream   Input stream for s values (scale factors)
 * @param q_stream     Output stream for buffered q values
 * @param s_stream     Output stream for buffered s values
 */
...
/** @brief Reference input data for quantized tensor */
...
/**
 * @brief Test function for a single layer of the Llama multiplexer.
 *
