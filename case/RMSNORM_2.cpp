/**
 * This module tests the RMS normalization operation (second variant) by loading reference data, creating input streams,
 * executing the RMSNORM operation, and comparing the output against reference data. The implementation is optimized
 * for HLS with stream interfaces.
 */
#include "../src/common.h"
#include "../src/rmsnorm2.h"
#include <cstdint> 
#include <stdint.h>
#include "../src/utils.h"
 ...
 *
 * Executes the RMS normalization operation (second variant) for a specific layer on the input stream and produces an output stream.
 *
...
/**
 * @brief Test function for a single RMSNORM layer (second variant).
 *
...
void test_layer(int l){
    ...
    auto INPUT_XLN                = read_tensor<int64_t>(file_path + "/rms2_layer"+file_path_suffix);
