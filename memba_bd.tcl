...
HBM_WRITE_BACK_CORRECTED_DATA TRUE} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT_REQUESTED_OUT_FREQUENCY {500,150.000,300.000,100.000,100.000,100.000,100.000} \
...
HBM_WRITE_BACK_CORRECTED_DATA TRUE} \
  ...
  set ACCELERATOR_0 [ create_bd_cell -type ip -vlnv user.org:user:ACCELERATOR:1.0 ACCELERATOR_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net ACCELERATOR_0_m_axi [get_bd_intf_pins ACCELERATOR_0/m_axi] [get_bd_intf_pins noc_lpddr4/S00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M02_AXI [get_bd_intf_pins ACCELERATOR_0/axilite] [get_bd_intf_pins smartconnect_1/M02_AXI]
  ...
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins CIPS_0/m_axi_fpd_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins cips_noc/aclk0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins noc_lpddr4/aclk0] [get_bd_pins ACCELERATOR_0/clk]
  connect_bd_net -net rst_clk_wizard_1_300M_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins ACCELERATOR_0/resetn]
  ...
  assign_bd_address -offset 0xA4010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CIPS_0/M_AXI_FPD] [get_bd_addr_segs ACCELERATOR_0/axilite/reg0] -force
  ...
  assign_bd_address -offset 0x050000000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces ACCELERATOR_0/m_axi] [get_bd_addr_segs noc_lpddr4/S00_AXI/C0_DDR_CH1x2] -force
