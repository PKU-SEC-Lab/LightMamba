...
def create_tcls(instances_root: str, case_names, do_csim=False, do_csynth=False, do_cosim=False, do_export=False, do_syn=False, do_impl=False, cosim_random_stall=False, phys_opt="none", pipeline_style="stp"):
